        ...
        <form >
            <div class="col-auto">
                ...
                <div class="input-group mb-2">
                    ...
                    <div class="input-group-text border-0 bg-black text-blue">NAME</div>
                    </div>
                    <input type="text" class="form-control border-0 " id="inlineFormInputGroup" placeholder="Name">
                </div>
                 <div class="input-group mb-2">
                    <div class="input-group-prepend ">
                    <div class="input-group-text border-0 bg-black text-blue">EMAIL</div>
                    </div>
                    <input type="text" class="form-control border-0" id="inlineFormInputGroup" placeholder="Email">
                </div>
                 <div class="input-group mb-2">
                    <div class="input-group-prepend">
                    <div class="input-group-text border-0 bg-black text-blue">SUBJECT</div>
                    </div>
                ...
                <div class="form-group contact-textarea">
                    ...
                    <textarea class="form-control border-0 " id="exampleFormControlTextarea1" rows="10"></textarea>
                </div>
