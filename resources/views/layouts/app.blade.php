        ...
        <nav class="navbar navbar-expand-md nav-bg  sticky-top  justify-content-end menu" >
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav text-right ml-auto mr-2">
                        ...
                        @else
                            <li class="nav-item dropdown" style="border-bottom:none;">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown" style="padding:0;border:0;">
                                    <a id="logout" class="dropdown-item logout-bg" style="background-color:#0aa1d9;border:none;" href="{{ route('logout') }}"
